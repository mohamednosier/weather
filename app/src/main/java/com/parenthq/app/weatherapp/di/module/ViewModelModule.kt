...
import com.parenthq.app.weatherapp.di.ViewModelFactory
import com.parenthq.app.weatherapp.di.key.ViewModelKey
import com.parenthq.app.weatherapp.ui.dashboard.DashboardFragmentViewModel
import com.parenthq.app.weatherapp.ui.dashboard.forecast.ForecastItemViewModel
import com.parenthq.app.weatherapp.ui.main.MainActivityViewModel
import com.parenthq.app.weatherapp.ui.search.SearchViewModel
import com.parenthq.app.weatherapp.ui.search.result.SearchResultItemViewModel
import com.parenthq.app.weatherapp.ui.splash.SplashFragmentViewModel
import com.parenthq.app.weatherapp.ui.weather_detail.WeatherDetailViewModel
import com.parenthq.app.weatherapp.ui.weather_detail.weatherHourOfDay.WeatherHourOfDayItemViewModel
import dagger.Binds
